%global commit0 ffeaa1c7770c199bb1867bff9e1c0e1bfe9d17de
...
Conflicts:      kf5-kidentitymanagement-devel < 23.08.3-2
Requires:       %{name}%{?_isa} = %{version}-%{release}
Requires:       cmake(KF6CoreAddons)
Requires:       cmake(KPim6TextEdit)
%description    devel
...
%{_kf6_datadir}/dbus-1/interfaces/kf6_org.kde.pim.IdentityManager.xml
