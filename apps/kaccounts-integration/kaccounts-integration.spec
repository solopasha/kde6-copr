%global commit0 fd7ae8b7e8ab1b54c224a171115d9588813a9f5a
...
%cmake_kf5 -DKF6_COMPAT_BUILD=ON
%cmake_build
...
%{_kf6_libdir}/libkaccounts6.so.%{version_no_git}
...
%{_kf5_libdir}/libkaccounts.so.%{version_no_git}
