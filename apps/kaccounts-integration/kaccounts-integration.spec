...
%apps_source
Patch:   https://invent.kde.org/network/kaccounts-integration/-/merge_requests/49.patch
...
%{_kf6_libdir}/libkaccounts.so.2
%{_kf6_libdir}/libkaccounts.so.%{version}
%{_kf6_qmldir}/org/kde/kaccounts/

%files devel
%{_kf6_libdir}/libkaccounts.so
%{_kf6_libdir}/cmake/KAccounts/
