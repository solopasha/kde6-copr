%global commit0 090d7f6ad86b690b7d300fcc1211f0ffab04ac01
...
Recommends: kaddressbook >= %{majmin_ver_kf6}
Recommends: kmail >= %{majmin_ver_kf6}
Recommends: korganizer >= %{majmin_ver_kf6}
