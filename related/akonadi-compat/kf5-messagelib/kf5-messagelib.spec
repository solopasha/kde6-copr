...
rm -rf %{buildroot}%{_kf5_datadir}/config.kcfg/
rm -rf %{buildroot}%{_kf5_datadir}/knsrcfiles/
rm -rf %{buildroot}%{_kf5_datadir}/libmessageviewer/
rm -rf %{buildroot}%{_kf5_datadir}/org.kde.syntax-highlighting/
rm -rf %{buildroot}%{_kf5_datadir}/messagelist/
rm -rf %{buildroot}%{_kf5_datadir}/messageviewer/
