...
Obsoletes: polkit-qt-qt5 < 0.175.0-2
Provides:  polkit-qt-qt5 = %{version}-%{release}
...
Obsoletes: polkit-qt-qt5-devel < 0.175.0-2
Provides:  polkit-qt-qt5-devel = %{version}-%{release}
...
Obsoletes: polkit-qt-qt6 < 0.175.0-2
Provides:  polkit-qt-qt6 = %{version}-%{release}
...
Summary: Development files for PolicyKit Qt5 bindings
Obsoletes: polkit-qt-qt6-devel < 0.175.0-2
Provides:  polkit-qt-qt6-devel = %{version}-%{release}
